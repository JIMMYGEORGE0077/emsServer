...
employeeRegister = async (req, res) => {
    ...
    if (!fname || !lname || !email || !file || !mobile || !gender || !location) {
    ...
    try {
        ...
        if (preEmployee) {
            ...
            const newEmployee = new employees({ fname, lname, email, mobile, gender, profile: file, location })
